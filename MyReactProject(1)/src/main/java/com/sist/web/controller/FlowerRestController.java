...
@GetMapping("/flower/list_react")
public ResponseEntity<Map> flowerList(@RequestParam("page") int page,@RequestParam("cate_minor") String cate_minor,@RequestParam("name") String name)
{
	Map map;
	int rowsize=10;
